...
<br><br>
<div class="container"> 
<a style="font-family:quicksand;font-size:25;color:red"><i class="fa fa-chain-broken" aria-hidden="true"></i>&nbsp;&nbsp;The gallery Section is Under Devlopment now</a>    
</div> 
...
<div id="ninja-slider">
        <div class="slider-inner">
            <ul>
                                <?php
                foreach(glob('./images/block/*.*') as $filename)
                {
                     echo '<li>';
                     echo '<a class="ns-img" href="'.$filename.'"></a>';
                     echo '<div class="caption">caption goes here</div>';
                     echo '</li>';
                }
                    ?> 
                <li>
